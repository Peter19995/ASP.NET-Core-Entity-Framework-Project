...
namespace EF_DataAccess.Migrations
{
    ...
    [Migration("20230719101950_addManyToManyRelationUsingFluent_MappingTable")]
    partial class addManyToManyRelationUsingFluent_MappingTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EF_Model.Models.Fluent_BookAuthorMap", b =>
                {
                    b.Property<int>("Author_Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EF_Model.Models.Fluent_Book", b =>
                {
                    b.HasOne("EF_Model.Models.Fluent_Publisher", "Publisher")
                        .WithMany("Books")
                        .HasForeignKey("Publisher_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EF_Model.Models.Fluent_BookAuthorMap", b =>
                {
                    b.HasOne("EF_Model.Models.Fluent_Author", "Author")
